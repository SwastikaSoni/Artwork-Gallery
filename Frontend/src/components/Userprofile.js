...
function Userprofile() {
  ...
  return (
    <>
      {isLoggedIn ? (
        <>
          <div className="container mx-auto px-4 py-8 bg-black text-white border-b-2 border-white">
            ...
            <div className="mt-8">
                      ...
                      >
                        ...
                        <div className="p-4">
                          ...
                          <p className="text-gray-600">
                            ...
                            {/* {data.arttag && <>Art</>}
                            {"  "} */}
                            {data.kalam && <>Kalamkari</>}
                            {"  "}
                            {data.madhubani && <>Madhubani</>}
                            {"  "}
                            {data.mysore && <>Mysore</>}
                            {"  "}
                          </p>
              ...
              <div className="flex justify-end me-10 mt-8">
                <button
                  type="button"
